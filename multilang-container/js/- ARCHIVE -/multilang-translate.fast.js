                    ...
                    availableLanguages.forEach(function(lang) {
                        if (tokenTranslations[lang]) {
                            ...
                            if (hideFilterEnabled) {
                                ...
                                tokenSpans += '<span class="translate lang-' + lang + '" data-translation="' + encoded_content + '">' + tokenTranslations[lang] + '</span>';
                            } else {
                                // When hide filter is not active, use display styles  
                                var encoded_content = encodeForDataAttr(tokenTranslations[lang]);
                                tokenSpans += '<span class="translate lang-' + lang + '" data-translation="' + encoded_content + '" style="display: ' + display + ';">' + tokenTranslations[lang] + '</span>';
                            }
                        }
                    });
                ...
                if (node.nodeType === Node.TEXT_NODE) {
                    ...
                    if (translated !== originalText) {
                        ...
                        if (sectionTranslations && sectionTranslations[defaultLang]) {
                            // Try direct key
                            if (sectionTranslations[defaultLang][originalText]) {
                                defaultText = sectionTranslations[defaultLang][originalText];
                            } else {
                                ...
                                for (var cat in sectionTranslations[defaultLang]) {
                                    if (sectionTranslations[defaultLang].hasOwnProperty(cat) && typeof sectionTranslations[defaultLang][cat] === 'object') {
                                        if (sectionTranslations[defaultLang][cat][originalText]) {
                                            defaultText = sectionTranslations[defaultLang][cat][originalText];
                                            break;
                                        }
                                    }
                                }
